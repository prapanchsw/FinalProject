import { Avatar, Button, Container, Divider, Paper, Table, TableBody, TableCell, TableHead, TableRow, TextField, Typography } from '@mui/material';
...
const AdminProfile = () => {
   ...
   const navigate=useNavigate();
    useEffect(() => {
        axios.get("http://localhost:3000/adminview")
            .then((res) => {
    ...
    const handleEditClick = () => {
        ...
        navigate(`/updateadmin`, { state: { id,email,name} });
    };
